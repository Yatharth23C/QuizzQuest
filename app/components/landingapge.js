    ...
    <>  
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-900 text-gray-200 p-6">
        ...
        <div className="max-w-3xl text-center space-y-6 mt-12">
          ...
          <p className="bg-gray-800 rounded-lg p-4">
          ...
          {!session ? (
            <button
              onClick={() => signIn()}
              className="bg-yellow-500 text-gray-900 py-2 px-6 rounded-lg font-semibold hover:bg-yellow-400 transition duration-200"
            >
              Login
            </button>
          ) : (
            <>
              <button 
                onClick={() => signOut()}
                className="bg-red-600 relative right-2 text-gray-900 py-2 px-6 rounded-lg font-semibold hover:bg-red-500 transition duration-200"
              >
                Sign Out
              </button>
              ...
              {role === 'teacher' && (
                <div className="mt-4 space-x-4">
                  <button
                    ...
                    className="bg-blue-600 text-gray-900 py-2 px-6 rounded-lg font-semibold hover:bg-blue-500 transition duration-200"
                  >
                    Create Questions
                  </button>
                  <button
                    onClick={handleViewQuestions}
                    className="bg-purple-600 text-gray-900 py-2 px-6 rounded-lg font-semibold hover:bg-purple-500 transition duration-200"
                  >
                    View Questions
                  </button>
                </div>
